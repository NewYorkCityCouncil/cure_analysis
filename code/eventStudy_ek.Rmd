...
#Only non-touching pure controls and pre-2019 Cure
...
ggplot(data=temp, aes(x=year, y=numShootings, color=controlSO)) +
  geom_point(size=2) +
  geom_line()+
  ylim(0,20)+
  labs(x="Year", y="Number of Shootings (per precinct)",
       title="Avg. Number of Shootings, Non-Cure Precincts",
       color="") +
  scale_color_manual(values=c('red','blue'),labels=c("Not Touching", 'Touching'))
  theme(plot.title = element_text(size=16, face='bold',hjust=0.5))
  theme_minimal()
